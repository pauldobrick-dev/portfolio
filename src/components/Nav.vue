...
#nav-wrapper {
    ...
    #contact-button {
        ...
        width: 70px;
        height: 30px;
        background-color: $component-col;
        border-radius: 5px;
    }
}
</style>
